	...
	return (
		<div style={{ padding: 24, background: '#fff' }}>
			<Row gutter={[16, 16]}>
				<Col span={8}>
					<Card bordered={true}>
						<Statistic title='Tổng số lịch hẹn' value={lichHenList.length} />
					</Card>
				</Col>
				<Col span={8}>
					<Card bordered={true}>
			...
			<Row gutter={24} style={{ marginTop: 24 }}>
				<Col span={12}>
					...
					<Table
						dataSource={thongKeDoanhThu.theoDichVu}
						columns={columnsDoanhThuDV}
						rowKey='id'
						pagination={false}
						bordered
					/>
				...
				<Col span={12}>
					...
					<Table
						dataSource={thongKeDoanhThu.theoNhanVien}
						columns={columnsDoanhThuNV}
						rowKey='id'
						pagination={false}
						bordered
					/>
