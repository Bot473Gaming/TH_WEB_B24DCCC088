		...
		>
			...
			>
				<Select
					...
					placeholder={!ngayChon || !gioChon ? 'Vui lòng chọn ngày và giờ trước' : 'Chọn nhân viên'}
				>
			...
			<Form.Item label='Dịch vụ' name='dichVuId' rules={[{ required: true, message: 'Vui lòng chọn dịch vụ!' }]}>
				<Select>
